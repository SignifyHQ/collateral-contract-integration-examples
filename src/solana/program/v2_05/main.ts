...
export type Main = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "docs": [
        "Cancels a pending permissionless timelock withdrawal request"
      ],
      "discriminator": [
        106,
        196,
    ...
    },
    {
      ...
      "docs": [
        "Closes a stale CollateralAdminSignaturesV2 account and sends rent to its stored rent payer"
      ],
      "discriminator": [
        185,
        94,
      ...
      "accounts": [
        ...
        },
        {
          "name": "collateralAdminSignatures",
          "docs": [
            "The stale CollateralAdminSignaturesV2 account to close."
          ],
          "writable": true,
          "pda": {
            "seeds": [
    ...
    },
    {
      ...
      "docs": [
        "Creates a new TimelockConfig for a Coordinator"
      ],
      "discriminator": [
        64,
        20,
      ...
      "accounts": [
        {
          "name": "sender",
          "docs": [
            "The sender of the instruction. Must be the coordinator's collateral creator."
          ],
          "writable": true,
          "signer": true
        },
        ...
        },
        {
          "name": "coordinator",
          "docs": [
            "The coordinator that owns the collateral. The sender must be the collateral creator."
          ]
        },
        {
          "name": "collateral",
          "docs": [
            "The collateral to migrate (V1 or V2) - will be rewritten as SingleSignerCollateral"
          ],
          "writable": true
        },
        {
    ...
    },
    {
      ...
      "docs": [
        "Executes a permissionless timelock withdrawal (timelock or expedited path)"
      ],
      "discriminator": [
        139,
        145,
      ...
      "accounts": [
        ...
        },
        {
          "name": "coordinator",
          "docs": [
            "The coordinator account that governs the collateral."
          ]
        },
        {
          "name": "collateral",
          "docs": [
            "The collateral account from which funds will be withdrawn. Must belong to coordinator."
          ]
        },
        {
          "name": "collateralAuthority",
          "docs": [
            "The collateral authority PDA that holds the assets."
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "withdrawalRequest",
          "docs": [
            "The pending withdrawal request to execute. Closed on success with rent returned to rent_collector."
          ],
          "writable": true,
          "pda": {
            "seeds": [
        ...
        },
        {
          "name": "rentPayer",
          "docs": [
            "Pays rent if init_if_needed creates the recipient ATA."
          ],
          "writable": true,
          "signer": true
        },
        {
          "name": "recipient",
          "docs": [
            "The recipient of the withdrawn assets. Must match withdrawal_request.recipient."
          ],
          "writable": true
        },
        {
          "name": "asset",
          "docs": [
            "The SPL mint of the asset to withdraw. None for native SOL."
          ],
          "optional": true
        },
        {
          "name": "collateralTokenAccount",
          "docs": [
            "The collateral authority's token account for the asset being withdrawn."
          ],
          "writable": true,
          "optional": true
        },
        {
          ...
          "docs": [
            "The recipient's token account for the asset being received."
          ],
          "writable": true,
          "optional": true,
          "pda": {
    ...
    },
    {
      ...
      "docs": [
        "Requests a permissionless timelock withdrawal from a multi-admin collateral"
      ],
      "discriminator": [
        239,
        173,
      ...
      "accounts": [
        ...
        },
        {
          "name": "rentPayer",
          "docs": [
            "Pays rent for the WithdrawalRequest and receives rent from the closed signatures account."
          ],
          "writable": true,
          "signer": true
        },
        ...
        },
        {
          "name": "collateralAuthority",
          "docs": [
            "The collateral authority PDA that holds native SOL and owns collateral token accounts."
          ],
          "pda": {
            "seeds": [
              {
        ...
        },
        {
          "name": "timelockConfig",
          "docs": [
            "Must always be passed at the deterministic PDA address to prevent bypass of enabled=false."
          ]
        },
        {
          "name": "asset",
        ...
        },
        {
          "name": "collateralTokenAccount",
          "docs": [
            "The collateral authority's token account for the requested SPL asset."
          ],
          "optional": true
        },
        {
    ...
    },
    {
      ...
      "docs": [
        "Requests a permissionless timelock withdrawal from a single-signer collateral"
      ],
      "discriminator": [
        59,
        245,
      ...
      "accounts": [
        {
          "name": "owner",
          "docs": [
            "The collateral owner. Signs the transaction directly."
          ],
          "writable": true,
          "signer": true
        },
        {
          "name": "rentPayer",
          "docs": [
            "Pays rent for the WithdrawalRequest and is stored as its close rent collector."
          ],
          "writable": true,
          "signer": true
        },
    ...
    },
    {
      ...
      "docs": [
        "Updates an existing TimelockConfig for a Coordinator"
      ],
      "discriminator": [
        21,
        164,
          ...
          },
          {
            ...
            "fields": [
              ...
              },
              {
                "name": "asset",
                "docs": [
                  "The asset to withdraw (Pubkey::default() for SOL)"
                ],
                "type": "pubkey"
              },
              {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "feedId",
            "docs": [
              "The optional feed id corresponding to the price oracle."
            ],
            "type": {
              "option": "string"
            }
          },
          {
            "name": "priceUncertaintyThreshold",
            "docs": [
              "The maximum price uncertainty allowed for the asset operations."
            ],
            "type": "u32"
          },
          {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "enabled",
            "docs": [
              "When false, new requests are rejected (existing ones can still execute/cancel)"
            ],
            "type": "bool"
          }
        ]
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "requester",
            "docs": [
              "Admin/owner who initiated (verified admin at request time)"
            ],
            "type": "pubkey"
          },
          {
            "name": "rentCollector",
            "docs": [
              "Receives rent back when this account is closed."
            ],
            "type": "pubkey"
          },
          {
          ...
          },
          {
            "name": "asset",
            "docs": [
              "SPL mint (or Pubkey::default for native SOL)"
            ],
            "type": "pubkey"
          },
          {
