  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "collateral";
          docs: ["The Collateral account to increase the funds nonce."];
          writable: true;
        },
        {
          name: "systemProgram";
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "collateral";
          docs: ["The Collateral Account the Statement is associated to. Must be related with the coordinator."];
          writable: true;
        },
        {
          name: "collateralAuthority";
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "collateral";
          docs: ["The collateral account that must be owned by the coordinator."];
        },
        {
          name: "supportedAsset";
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "collateral";
          docs: ["The collateral account that custody the funds to pay."];
        },
        {
          name: "supportedAsset";
          docs: ["The supported asset account to validate if the asset to pay is supported by the coordinator."];
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "collateral";
          docs: ["The collateral account the statement belongs to. It must belong to the given coordinator."];
        },
        {
          name: "statement";
          docs: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "collateral";
          docs: ["The collateral account the statement will belong to. It must belong to the given coordinator."];
        },
        {
          name: "statement";
          docs: [
